export const fr = {
    ...
    // Passwords
    'text-password-input': 'Votre mot de passe',
    //'setPassword': 'Set Password',
    'your-identity-password': 'Mot de passe pour votre identité',
    ...
    // screen: password set
    'password-set-next-action':'Créons maintenant votre profil.<br/>Vous ne rendrez visibles que les informations que vous souhaitez.',
    ...
    'current-active-profile': 'Profil actif',
